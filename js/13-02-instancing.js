...
async function main() {
  ...
  const numObjs = 50;
  const positions = new Array(numObjs * numObjs * numObjs);
  ...
  const obj = await cg.loadObj("objects/cubito/cubito.obj", gl, objPrgInf, transforms);
  ...
  function render(elapsedTime) {
    ...
    for (const { vertexArrayInfo, vao } of obj) {
